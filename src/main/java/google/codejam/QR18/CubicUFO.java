...
public class CubicUFO {
  ...
  final static String fileName = "D-small";
...
//    Scanner sc = new Scanner(System.in);
  ...
  private static void findTheCoordinates(double i, double j) {
    if (i == 0) {
      System.out.println(df2.format(0.5 * Math.cos(Math.toRadians(j))) + " "
          + df2.format(0.5 * Math.sin(Math.toRadians(j))) + " 0");
      System.out.println(df2.format(0.5 * Math.cos(Math.toRadians(90 + j))) + " "
          + df2.format(0.5 * Math.sin(Math.toRadians(90 + j))) + " 0");
...
//          + df2.format(0.5 * Math.sin(Math.toRadians(i)) * Math.cos(Math.toRadians(90 + j))) + " " + df2.format(0.5 * Math.cos(Math.toRadians(i))));
//      System.out.println(df2.format(0.5 * Math.sin(Math.toRadians(i)) * Math.cos(Math.toRadians(j))) + " "
//          + df2.format(0.5 * Math.sin(Math.toRadians(i)) * Math.cos(Math.toRadians(j))) + " " + df2.format(0.5 * Math.cos(Math.toRadians(i))));
//    }
    else {
//      System.out.println("***************");
      //The corrected coordinates:
      System.out.println(df2.format(0.5 * Math.cos(90 - j))
          + " " + df2.format(0.5 * Math.cos(i) * Math.sin(90 - j))
          + " " + df2.format(0.5 * Math.sin(i)));
      System.out.println(df2.format(0.5 * Math.cos(-j)) + " "
          + df2.format(0.5 * Math.sin(-j) * Math.sin(i)) + " "
          + df2.format(0.5 * Math.sin(-i)));
      System.out.println(df2.format(0) + " "
          + df2.format(0.5 * Math.sin(i))
          + " " + df2.format(0.5 * Math.cos(i)));
    }
