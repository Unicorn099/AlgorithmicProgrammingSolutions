...
public class DifferentWaysToAddParenthesesSubmittedOne {

  public static void main(String[] args) {
    String exp = "10+5*8-9+2";
    DifferentWaysToAddParenthesesSubmittedOne differentWaysToAddParentheses =
        new DifferentWaysToAddParenthesesSubmittedOne();
